...
**messageVersions** | [**List&lt;SendSmtpEmailMessageVersions&gt;**](SendSmtpEmailMessageVersions.md) | You can customize and send out multiple versions of a templateId. Some global parameters such as **to(mandatory), bcc, cc, replyTo** can also be customized specific to each version. The size of individual / cumulative params in all the messageVersions shall not exceed 100 KB limit. |  [optional]
